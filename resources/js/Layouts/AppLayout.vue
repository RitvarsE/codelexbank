                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('transaction.create')"
                                              :active="route().current('transaction.create')">
                                    Transaction
                                </jet-nav-link>
                                <jet-nav-link :href="route('accounts.create')"
                                              :active="route().current('accounts.create')">
                                    Open account
                                </jet-nav-link>
                                <jet-nav-link :href="route('transactions.history')"
                                              :active="route().current('transactions.history')">
                                    History
                                </jet-nav-link>
                            </div>
                            <div class="ml-3 relative mt-3.5">
                                <jet-dropdown>
                                    <template #trigger>
                                        <button
                                            type="button"
